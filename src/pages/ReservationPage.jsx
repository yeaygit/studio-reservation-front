    ...
    [
      {
        ...
        label: '증명사진',
        duration: 30,
        description: '개인 증명사진입니다. 6장 인화해 드리고 상반신 사진 1장 같이 드립니다.',
        price: 45000
      },
      {
        id: 2,
        ...
        label: '여권사진',
        duration: 30,
        description: '개인 여권사이즈 사진입니다. 6장 인화해 드리고 상반신 사진 1장 같이 드립니다.',
        price: 45000
      },
      {
        id: 3,
        ...
        label: '증명 + 여권사진',
        duration: 30,
        description: '개인 증명 + 여권사이즈 사진입니다. 각 6장씩 인화해 드리고 상반신 사진 1장 같이 드립니다.',
        price: 55000
      },
      {
        id: 4,
        ...
        label: '프로필',
        duration: 60,
        description: '개인 프로필 사진입니다. 상반신만 촬영해드리고 얼굴 위주 프로필 사진입니다. 컨셉 정해서 오시는 것을 추천드립니다. 사진 2장 선택 가능하고 인화해드립니다.',
        price: 60000
      },
    ]
  )

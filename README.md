...
| `/service/costume` | 의상 & 소품 안내 | 플레이스홀더 |
...
| 경로 | 설명 | 상태 |
| --- | --- | --- |
| `/admin` | 관리자 대시보드 | 플레이스홀더 성격 |
| `/admin/reservations` | 예약내역 관리 | 대시보드 플레이스홀더 연결 |
| `/admin/reservation-settings` | 예약 시간 설정 | 구현됨 |
| `/admin/holidays` | 휴일 관리 | 구현됨 |
| `/admin/blacklist` | 블랙리스트 차단 | 대시보드 플레이스홀더 연결 |
| `/admin/alimtalk` | 카카오 알림톡 문구 관리 | 대시보드 플레이스홀더 연결 |
